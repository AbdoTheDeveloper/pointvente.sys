                                ...
                                <div class="row m-0">
                                    <div class="col-lg container-fluid page__container">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <form method="POST" action="{{ route('admin.store_cat') }}" enctype="multipart/form-data"   >
                                                     {{ csrf_field() }}
                                            ...
                                            <div class="bootstrap-filestyle input-group">
                                                ...
                                                <input type="text" class="form-control " placeholder="" disabled="">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input id="nom" value="{{Request::old('nom')}}" name="nom" type="text" class="form-control" placeholder="Nom Categorie" > 
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
