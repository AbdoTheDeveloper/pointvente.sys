                                    ...
                                    <div class="row m-0">
                                        <div class="col-lg container-fluid page__container">
                                            ...
                                            <div class="card">
                                               ...
                                               <form method="POST" action="{{route('admin.update_fournisseur')}}"  enctype="multipart/form-data"   >
                                                    {{ csrf_field() }}
                                                            ...
                                                            <div class="form-row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <div role="group" class="input-group input-group-merge">
                                                                        <input id="nom_frns"  type="text" name="nom_frns" placeholder="Nom fournisseur"  class="form-control form-control-prepended" value="{{$fournisseur->nom_frns}}">
                                                    ...
                                                    <div class="list-group-item">
                                                        <div role="group" aria-labelledby="label-profilename" class="m-0 form-group">
                                                            <div class="form-row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <div role="group" class="input-group input-group-merge">
                                                                        <input  value="{{$fournisseur->tel}}"   id="tel" name="tel" type="phone" placeholder="N° téléphone fournisseur"  class="form-control form-control-prepended" aria-describedby="description-profilename">
                                                                    </div>
                                                    ...
                                                    <div class="list-group-item">
                                                        <div role="group" aria-labelledby="label-profilename" class="m-0 form-group">
                                                            <div class="form-row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <div role="group" class="input-group input-group-merge">
                                                                        <input value="{{$fournisseur->email}}"   id="email" name="email" type="email" placeholder="Email fournisseur"  class="form-control form-control-prepended" aria-describedby="description-profilename">
                                                                    </div>
                                                    ...
                                                    <div class="list-group-item">
                                                        <div role="group" aria-labelledby="label-adresse" class="m-0 form-group">
                                                            <div class="form-row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <textarea id="adress" name="adress" placeholder="adresse ..." rows="3" class="form-control">{{$fournisseur->adress}}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="list-group-item">
                                                        <div role="group" aria-labelledby="label-remarque" class="m-0 form-group">
                                                            <div class="form-row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <textarea id="remarque" name="remarque" placeholder="Remarque ..." rows="3" class="form-control">{{$fournisseur->remarque}}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
