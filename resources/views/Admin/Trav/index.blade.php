                                ...
                                <div class="card-body">
                                    <div class="media flex-wrap align-items-center">
                                        ...
                                        <div class="media-right  col-md-3 mt-2 mt-xs-plus-0 ">
                                            <a class="btn btn-success pull-right" href="{{ route('admin.create_travailleur') }}"> <i class="fa fa-plus"></i>&nbsp;Ajouter un travailleur
</a>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="table-responsive border-bottom" data-toggle="lists" data-lists-values='["js-lists-values-employee-name"]'>
                                                ...
                                                <table class="table table-centered table-bordered table-striped" id="myTable">
                                                    ...
                                                    <tbody class="list" id="search">
                                                        ...
                                                        @foreach($travailleurs as $dir)

                                                        <tr>

                                                            <td>

                                                                <span class="js-lists-values-employee-name">{{ $dir->nom}} </span>

                                                            </td>
                                                            <td><small class="text-muted">{{ $dir->username }}</small></td>           
                                                            <td>

                                                                <span class="js-lists-values-employee-name">{{ $dir->modeCaisse }}</span>
                                                            ...
                                                            <td>
                                                                <div class="button-list">
                                                                   <a  href="{{ route('admin.delete_travailleur',["id"=>$dir->id]) }}" onclick="return confirm('Êtes-vous sûr de bien vouloir supprimer cet élément');" class="btn btn-danger btn-sm">
                                                                        <i class="material-icons">close</i>
                                                                    </a>
                                                                   
                                                                     <a href="{{ route('admin.edit_travailleur',["id"=>$dir->id]) }}" type="button"   class="btn btn-warning btn-sm">
