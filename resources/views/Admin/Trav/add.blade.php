                             ...
                             <div class="container page__container p-0">
                                <div class="row m-0">
                                    <div class="col-lg container-fluid page__container">
                                        ...
                                        <div class="card">
                                            <form method="post" action="{{route('admin.store_travailleur')}}" enctype="multipart/form-data"   >
                                            {{ csrf_field() }}
                                                            ...
                                                            <div class="form-row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <div role="group" class="input-group input-group-merge">
                                                                        <input id="username" type="text" name="username" placeholder="Login travailleur"  class="form-control form-control-prepended" aria-describedby="description-profilename"  value="{{old('username')}}">
                                                    ...
                                                    <div class="list-group-item">
                                                        <div role="group" aria-labelledby="label-profilename" class="m-0 form-group">
                                                            <div class="form-row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <div role="group"  class="input-group input-group-merge">
                                                                        <input value="{{Request::old('password')}}" id="password" type="text" name="password"  placeholder="Mot de passe travailleur"  class="form-control form-control-prepended" aria-describedby="description-profilename">
                                                    ...
                                                    <div class="list-group-item">
                                                        <div role="group" aria-labelledby="label-profilename" class="m-0 form-group">
                                                            <div class="form-row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <div role="group" class="input-group input-group-merge">
                                                                        <input id="nom"  type="text" name="nom" placeholder="Nom travailleur"  class="form-control form-control-prepended" value="{{old('nom')}}">
                                                    ...
                                                    <div class="list-group-item">
                                                        <div role="group" aria-labelledby="label-profilename" class="m-0 form-group">
                                                            <div class="form-row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <div role="group" class="input-group input-group-merge">
                                                                        <input value="{{old('modeCaisse')}}" id="modeCaisse" name="modeCaisse" type="text" placeholder="Mode Caisse"  class="form-control form-control-prepended" >
                                                     ...
                                                     <div class="list-group-item">
                                                        <div role="group" aria-labelledby="label-profilename" class="m-0 form-group">
                                                            <div class="form-row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <div role="group" class="input-group input-group-merge">
                                                                        <input value="{{old('email')}}" id="email" name="email" type="email" placeholder="Email travailleur"  class="form-control form-control-prepended" >
                                                                    </div>
                                                                    <small id="description-profileage" class="form-text text-muted">Email travailleur.</small>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div> --}}
