    ...
    <link type="text/css" href="{{url('https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css')}}" rel="stylesheet">
   
    <link type="text/css" href="{{url('assets/css/select2.min.css')}}" rel="stylesheet">
    
    <link type="text/css" href="{{url('assets/css/select2-bootstrap.min.css')}}" rel="stylesheet">
