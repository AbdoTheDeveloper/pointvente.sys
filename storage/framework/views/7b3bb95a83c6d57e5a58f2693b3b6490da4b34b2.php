			...
			if (remise > 0) {
				...
				// });
					...
					if (localStorage.getItem("isRetour") == 1) {
						...
						$.each(arraytick, function(index, val) {
							totalTicketDH = parseFloat(totalTicketDH) + parseFloat(arraytick[index].prix);
							totalTicketDHSansRemise = parseFloat(totalTicketDHSansRemise) + parseFloat(arraytick[index].prix_sans_remise * arraytick[i].qte);
						});
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Trav.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-installation\xampp-5.6\htdocs\pointvente.sys\resources\views/Trav/index.blade.php ENDPATH**/ ?>