...
<div class="box" id="hiddenbox">
    <div class='inner'>
        ...
        <div id="info_ticket_detail">
            ...
            <div class='wp'><?php echo e((float)$Cloturage->carte + (float)$Cloturage->montant_espece + (float)$Cloturage->montant_compte + (float)$Cloturage->montant_offert); ?> DH</div>
        </div>
        ...
        <div id="info_ticket_detail">
            ...
            <div class='wp'><b><?php echo e((float)$Cloturage->carte + (float)$Cloturage->montant_espece + (float)$Cloturage->montant_compte + (float)$Cloturage->montant_offert); ?> DH</b></div>
        </div>
        <br>
...
</div><?php /**PATH C:\xampp-installations\xampp5.6\htdocs\pointvente.sys\resources\views/Trav/print/Imprimer_Cloturage_v2.blade.php ENDPATH**/ ?>