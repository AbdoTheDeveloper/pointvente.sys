            ...
            <div class="card-body">
                <div class="media flex-wrap align-items-center">
                    ...
                    <div class="media-right  col-md-3 mt-2 mt-xs-plus-0 ">
                        ...
                        <a class="btn btn-success pull-right" href="<?php echo e(route('ajouter-etudiants')); ?>"> <i class="fa fa-plus"></i>&nbsp;Ajouter un client</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <table class="table table-centered table-bordered table-bordred table-striped" id="myTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="nowrap">Sold Buf</th>
                                        <th class="nowrap">Sold Rest</th>
                                        <th class="nowrap">Tel</th>
                                        <th class="nowrap">Classe</th>
                                        <th class="nowrap"></th>
                                    </tr>
                                </thead>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <form method="post" id="pdfform" target="_blank" action="<?php echo e(route('admin.export_pdf_card')); ?>" enctype="multipart/form-data"   >
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control select2-single   form-control-prepended select2-single" name="id_niv" id="id_niv">
                                                    ...
                                                    <option <?php if(Request::old('id_niv')==$niveau->id) echo "selected"; ?>  value="<?php echo e($niveau->id); ?>"><?php echo e($niveau->Desc_niveau); ?></option>
...
"serverSide": true,
"ajax": {
url: "<?php echo e(route('getetudiants')); ?>"
},
"columns": [
{ data: 'nom',   name: 'nom', },
{ data: 'age',   name: 'age', },
{ data: 'sold_b',   name: 'sold_b', },
{ data: 'sold_r',   name: 'sold_r', },
{ data: 'tele',   name: 'tele', },
                ...
                "render": function ( data, type, row ) {
                    console.log(row)
                     return  `<div class="button-list">
                      <a  href="<?php echo e(url('admin/supprimer-etudiants/')); ?>/${row.id}/"  onclick="return confirm('Êtes-vous sûr de bien vouloir supprimer cet élément');" class="btn btn-danger btn-sm">
                     <i class="material-icons">close</i> </a>
                     <a href="<?php echo e(url('admin/modifier-etudiants/')); ?>/${row.id}/" type="button" class="btn btn-warning btn-sm">
...
$('body').on("click" ,".cardinfo", function(){
	 	...
	 	console.log(id_eleve);
   		$.ajax({
	            url: "<?php echo e(route('admin.get_card_eleve')); ?>",
	            type: 'get',
	            data:{id:id_eleve},
...
$('body').on("click" ,"#savesold", function(){
	 	...
	 	console.log(id_eleve);
   		$.ajax({
	            url: "<?php echo e(route('admin.add_sold_eleve')); ?>",
	            type: 'post',
                data:{id:id_eleve,
                    type: typesold,
                    sold:sold,
...
//    		$.ajax({
//                 url: "<?php echo e(route('admin.export_pdf_card')); ?>",
//                 type: 'POST',
...
mywindow.document.write('<html><head><title>' + document.title  + '</title>');
mywindow.document.write('<link rel="stylesheet" href="<?php echo e(url('assets/css/app.css')); ?>" type="text/css" />'); 
mywindow.document.write('</head><body >');
...
<?php echo $__env->make('Admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-installations\xampp5.6\htdocs\pointvente.sys\resources\views/Admin/Etudiant/index.blade.php ENDPATH**/ ?>