...
<?php endif; ?>
    <?php if($operation->remise>0): ?>
		...
		<h2>Total : Remise : <?php echo e($operation->remise); ?> %  <p> <?php echo e($operation->total_a_payer); ?> DH</p></h2>
...
<br>
    ...
    <p  style="display: inline-block; float:right;font-size:20px"><?php echo e($espece + $carte + $offert +$compte); ?> DH </p>

<?php /**PATH C:\xampp-installations\xampp5.6\htdocs\pointvente.sys\resources\views/Admin/recette/Imprimer_Cloturage.blade.php ENDPATH**/ ?>