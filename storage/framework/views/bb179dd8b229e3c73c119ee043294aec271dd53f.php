	...
	<div class="col-9">
		<div class="row" style="align-items: center;">
			...
			<div class="col-md-1 " id="remise_input">
				<div class=" bmd-form-group poidsInputGroup">
					<input type="text" autofocus name="remise" id="remise" class="form-control virtual-keyboard  " autocomplete="off" value="<?php echo e(old('remise')); ?>" data-kioskboard-type="numpad" changeplaceholder="Remise %"  placeholder="Remise %" style="height: 55px">
				</div>
			</div>
					...
					<div class="card" style="margin-top: 0px !important">
						<div class="justify-content-center">
							...
							<div class="row CategoryDiv">
								...
								<button class="click_btn cat" style=" height: 2rem; color: black;padding: 20px !important; display: flex;align-items: center;justify-content: center;margin: 0 10px 10px 0 ; cursor: pointer;" data-id="<?php echo e($cat->id); ?>" data-nom="<?php echo e($cat->nom_cat); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Trav.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-installations\xampp5.6\htdocs\pointvente.sys\resources\views/Trav/index.blade.php ENDPATH**/ ?>