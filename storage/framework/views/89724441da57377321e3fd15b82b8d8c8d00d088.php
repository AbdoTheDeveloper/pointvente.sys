                ...
                <div class="row m-0">
                    <div class="col-lg container-fluid page__container">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="<?php echo e(route('admin.update_article')); ?>"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <p><img alt=" <?php echo e(utf8_decode($prod->lebelle)); ?> "
                                                    src="<?php echo e(url('images/pro/' . $prod->img)); ?>" width="150"
                                                    class="rounded">
                                            </p>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2-single   select2-single fournisseur"
                                            ...
                                            <?php $__currentLoopData = $fournisseurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fournisseur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php if ($prod->id_frns == $fournisseur->id_frns) {
                                                    echo 'selected';
                                                } ?> data-val="<?php echo e($fournisseur->nom_frns); ?>">
                                                    <?php echo e($fournisseur->nom_frns); ?>
                                    ...
                                    <div class="form-group row">
                                        <label for="quiz_title" class="col-sm-3 col-form-label form-label">lebelle article
                                            :</label>
                                        <div class="col-sm-9">
                                            <input id="lebelle" value="<?php echo e($prod->lebelle); ?>" name="lebelle"
                                    ...
                                    <div class="form-group row">
                                        <label for="quiz_title" class="col-sm-3 col-form-label form-label">Code bar article
                                            :</label>
                                        <div class="col-sm-9">
                                            <input id="code_bar" value="<?php echo e($prod->code_bar); ?>" name="code_bar"
                                    ...
                                    <div class="form-group row">
                                        <label for="quiz_title" class="col-sm-3 col-form-label form-label">Prix Achat
                                            :</label>
                                        <div class="col-sm-9">
                                            <input id="prix_achat" value="<?php echo e($prod->prix_achat); ?>" name="prix_achat"
                                    ...
                                    <div class="form-group row">
                                        <label for="quiz_title" class="col-sm-3 col-form-label form-label">Prix vente
                                            :</label>
                                        <div class="col-sm-9">
                                            <input id="prix_vente" value="<?php echo e($prod->prix_vente); ?>" name="prix_vente"
                                    ...
                                    <div class="form-group row">
                                        <label for="quiz_title" class="col-sm-3 col-form-label form-label">Quantité
                                            :</label>
                                        <div class="col-sm-9">
                                            <input id="qte" value="<?php echo e($prod->qte); ?>" name="qte"
                                    ...
                                    <div class="form-group row">
                                        <label for="quiz_title" class="col-sm-3 col-form-label form-label">Quantité alerte
                                            :</label>
                                        <div class="col-sm-9">
                                            <input id="qte_alert" value="<?php echo e($prod->qte_alert); ?>" name="qte_alert"
                                    ...
                                    <div class="form-group row">
                                        <label for="quiz_title" class="col-sm-3 col-form-label form-label">Remise Max
                                            :</label>
                                        <div class="col-sm-9">
                                            <input id="remise_max" value="<?php echo e($prod->remise_max); ?>" name="remise_max"
...
<?php echo $__env->make('Admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Desktop\pointvente.sys\resources\views/Admin/article/edit.blade.php ENDPATH**/ ?>