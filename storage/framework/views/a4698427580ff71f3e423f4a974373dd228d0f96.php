        ...
        <div class="card " style="padding: 1rem;">
            ...
            <form action="<?php echo e(route('save_params')); ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input  name="enable_cusisine" id="enable_cusisine" class="form-control" type="checkbox">
                </div>

                <div class="form-group">
                    <label for=""> Ticket Barman : </label>
                    <input  name="enable_barman" id="enable_barman" class="form-control" type="checkbox">
                </div>
...
<?php echo $__env->make('Admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-installations\xampp5.6\htdocs\pointvente.sys\resources\views/Admin/params/index.blade.php ENDPATH**/ ?>