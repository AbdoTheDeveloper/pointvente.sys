                                ...
                                <div class="row m-0">
                                    <div class="col-lg container-fluid page__container">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                  <form method="POST" action="{{ route('admin.update_article') }}"  enctype="multipart/form-data"   >
                                                    {{ csrf_field() }}
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <p><img alt=" {{ utf8_decode($prod->lebelle) }} " src="{{url('images/pro/'.$prod->img)}}"   width="150" class="rounded">
                                                            </p>
                                            ...
                                            <div class="bootstrap-filestyle input-group">
                                                ...
                                                <input type="text" class="form-control " placeholder="" disabled="">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select class="form-control select2-single  " name="id_cat" id="id_cat">
                                                                @foreach($cats as $cat)
                                                                <option <?php if($prod->id_cat==$cat->id){echo "selected";} ?>  value="{{ $cat->id  }}">{{ $cat->nom_cat }}</option>
                                                                  @endforeach
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input id="lebelle" value="{{$prod->lebelle}}" name="lebelle" type="text" class="form-control" placeholder="lebelle article" > 
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="quiz_title" class="col-sm-3 col-form-label form-label">Code bar article :</label>
                                                        <div class="col-sm-9">
                                                            <input id="code_bar" value="{{$prod->code_bar}}" name="code_bar" type="text" class="form-control" placeholder="Code bar article" > 
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input id="prix_achat" value="{{$prod->prix_achat}}" name="prix_achat" type="text" class="form-control" placeholder="prix achat article" > 
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="quiz_title" class="col-sm-3 col-form-label form-label">Prix vente  :</label>
                                                        <div class="col-sm-9">
                                                            <input id="prix_vente" value="{{$prod->prix_vente}}" name="prix_vente" type="text" class="form-control" placeholder="prix vente article" > 
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input id="qte" value="{{$prod->qte}}" name="qte" type="text" class="form-control" placeholder="Quantité " > 
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input id="qte_alert" value="{{$prod->qte_alert}}" name="qte_alert" type="text" class="form-control" placeholder="Quantité alerte" > 
                                                        </div>
                                                    </div>
                                                    
                                                   <div class="form-group row">
                                                        <label for="quiz_title" class="col-sm-3 col-form-label form-label">Remise Max :</label>
                                                        <div class="col-sm-9">
                                                            <input id="remise_max" value="{{$prod->remise_max}}" name="remise_max" type="text" class="form-control" placeholder="Remise Max" > 
                                                        </div>
                                                    </div>
