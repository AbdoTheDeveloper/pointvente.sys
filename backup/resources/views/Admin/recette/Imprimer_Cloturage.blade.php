...
<div class="box" id="hiddenbox" >
	...
	<div id="info_ticket_detail">
        ...
        <!-- <div class='wp' >{{ (float)$Cloturage->montant}} DH</div> -->
	</div>
...
@endif
    @if($operation->remise>0)
		...
		<h2>Total : Remise : {{$operation->remise}} %  <p> {{$operation->total_a_payer}} DH</p></h2>
...
<h1 style="display: inline-block"> Total  Espece:  </h1>
           <p  style="display: inline-block; float:right;font-size:20px">{{$espece}} DH </p>

    <br>

<h1 style="display: inline-block"> Total  Carte:  </h1>
           <p  style="display: inline-block; float:right;font-size:20px">{{$carte}} DH </p>

<br>

<h1 style="display: inline-block"> Total  Compte:  </h1>
    <p  style="display: inline-block; float:right;font-size:20px">{{$compte}} DH </p>

    <br>

<h1 style="display: inline-block"> Total  Offert:  </h1>
    <p  style="display: inline-block; float:right;font-size:20px">{{$offert}} DH </p>


<br>
           <h1 style="display: inline-block"> Total  Recette:  </h1>
    <p  style="display: inline-block; float:right;font-size:20px">{{$espece + $carte + $offert +$compte}} DH </p>
