...
<div class="mdk-drawer-layout__content page ">
    <div class="container page__container">
        ...
        <form action="{{ route("refresh-pv") }}" method="POST">
        ...
        <div class="card " style="padding: 1rem;">
            ...
            <form action="{{ route("save_config") }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input value="{{$config->url_parent ? $config->url_parent : ''}}" name="url_parent" id="parent_url" class="form-control" type="text">
                </div>
        ...
        if (document.getElementById('parent_url').value != '') {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    document.getElementById('depots_list').value="{{$config->guid_depot}}";
