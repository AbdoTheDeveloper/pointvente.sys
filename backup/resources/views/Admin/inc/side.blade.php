        ...
        <div class="sidebar sidebar-left sidebar-dark bg-dark o-hidden" data-perfect-scrollbar>
            <div class="sidebar-p-y">
                ...
                <ul class="sidebar-menu">
                    ...
                    @if(Auth::user()->p_recette)
                    <li class="sidebar-menu-item">
                        <a class="sidebar-menu-button" href="{{ route('admin.index_recette') }}">
                    ...
                    <li class="sidebar-menu-item">
                        ...
                        <ul class="sidebar-submenu sm-indent collapse" id="direction_menu">
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('admin.index_travailleur') }} ">
                                    <span class="sidebar-menu-text">Tous les Travailleurs </span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('admin.create_travailleur') }} ">
                    ...
                    <li class="sidebar-menu-item">
                        ...
                        <ul class="sidebar-submenu sm-indent collapse" id="user_menu">
                            ...
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('admin.ajouter-user') }} ">
                    ...
                    <li class="sidebar-menu-item">
                        ...
                        <ul class="sidebar-submenu sm-indent collapse" id="Fournisseurs_menu">
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('admin.index_fournisseur') }} ">
                                    <span class="sidebar-menu-text">Tous les Fournisseurs </span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('admin.create_fournisseur') }} ">
                    ...
                    <li class="sidebar-menu-item">
                        ...
                        <ul class="sidebar-submenu sm-indent collapse" id="etudient_menu">
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('etudiants') }} ">
                                    <span class="sidebar-menu-text">Tous les clients</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('ajouter-etudiants') }} ">
                                    <span class="sidebar-menu-text">Ajouter des clients</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('admin.etat.recharge') }} ">
                    ...
                    <li class="sidebar-menu-item">
                        ...
                        <ul class="sidebar-submenu sm-indent collapse" id="niveau_menu">
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('niveau') }}">
                                    <span class="sidebar-menu-text">Tous les niveaux</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('AddNiveau') }}">
                    ...
                    <li class="sidebar-menu-item">
                        ...
                        <ul class="sidebar-submenu sm-indent collapse" id="class_menu">
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('classes') }}">
                                    <span class="sidebar-menu-text">Toutes les classes</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('AddClasse') }}">
                    ...
                    <li class="sidebar-menu-item">
                        ...
                        <ul class="sidebar-submenu sm-indent collapse" id="cat_menu">
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('admin.index_cat') }}">
                                    <span class="sidebar-menu-text">Tous les Categories</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('admin.create_cat') }}">
                    ...
                    <li class="sidebar-menu-item">
                        ...
                        <ul class="sidebar-submenu sm-indent collapse" id="article_menu">
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('admin.index_article') }}">
                                    <span class="sidebar-menu-text">Tous les Articles</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('admin.create_article') }}">
                                    <span class="sidebar-menu-text">Ajouter un Article</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('admin.inventaire_prods') }}">
                    ...
                    <li class="sidebar-menu-item">
                        ...
                        <ul class="sidebar-submenu sm-indent collapse" id="Stock_menu">
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('admin.index_prodStock') }}">
                                    <span class="sidebar-menu-text">Tous le Stock</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('admin.create_prodStock') }}">
                    ...
                    <li class="sidebar-menu-item">
                        ...
                        <ul class="sidebar-submenu sm-indent collapse" id="backup_menu">
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('backup') }}">
                    ...
                    <li class="sidebar-menu-item">
                        ...
                        <ul class="sidebar-submenu sm-indent collapse" id="bas">
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('etablissements') }}">
                                    <span class="sidebar-menu-text">Profil </span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('bascule') }}">
                                    <span class="sidebar-menu-text">Importation </span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('pv') }}">
                                    <span class="sidebar-menu-text">Point de vente </span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('params') }}">
