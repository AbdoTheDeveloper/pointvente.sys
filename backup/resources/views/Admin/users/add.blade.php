                             ...
                             <div class="container page__container p-0">
                                <div class="row m-0">
                                    <div class="col-lg container-fluid page__container">
                                        ...
                                        <h1 class="h2">Ajouter un user</h1>
                                                            ...
                                                            <div class="form-row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <div role="group" class="input-group input-group-merge">
                                                                        <input id="nom_frns"  type="text" name="nom_frns" placeholder="Nom user"  class="form-control form-control-prepended" value="{{old('nom_frns')}}">
                                                    ...
                                                    <div class="list-group-item">
                                                        <div role="group" aria-labelledby="label-profilename" class="m-0 form-group">
                                                            <div class="form-row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <div role="group" class="input-group input-group-merge">
                                                                        <input  value="{{Request::old('tel')}}"   id="tel" name="tel" type="phone" placeholder="N° téléphone user"  class="form-control form-control-prepended" aria-describedby="description-profilename">
                                                                    </div>
                                                    ...
                                                    <div class="list-group-item">
                                                        <div role="group" aria-labelledby="label-profilename" class="m-0 form-group">
                                                            <div class="form-row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <div role="group" class="input-group input-group-merge">
                                                                        <input value="{{Request::old('email')}}"   id="email" name="email" type="email" placeholder="Email user"  class="form-control form-control-prepended" aria-describedby="description-profilename">
                                                                    </div>
