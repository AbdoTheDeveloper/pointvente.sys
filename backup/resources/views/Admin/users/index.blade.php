                                ...
                                <div class="card-body">
                                    <div class="media flex-wrap align-items-center">
                                        ...
                                        <div class="media-right  col-md-3 mt-2 mt-xs-plus-0 ">
                                            <a class="btn btn-success pull-right" href="{{ route('admin.create_user') }}"> <i class="fa fa-plus"></i>&nbsp;Ajouter un user
</a>
                                        </div>
                                    </div>
                                </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="button-list">
                                                                   <a  href="{{ route('admin.deleteuser',["id"=>$dir->id]) }}" onclick="return confirm('Êtes-vous sûr de bien vouloir supprimer cet élément');" class="btn btn-danger btn-sm">
                                                                        <i class="material-icons">close</i>
                                                                    </a>
                                                                   
                                                                     <a href="{{ route('admin.edit_user',["id"=>$dir->id]) }}" type="button"   class="btn btn-warning btn-sm">
