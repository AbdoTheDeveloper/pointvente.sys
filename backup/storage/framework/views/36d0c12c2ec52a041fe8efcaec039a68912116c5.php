                             ...
                             <div class="container page__container p-0">
                                <div class="row m-0">
                                    <div class="col-lg container-fluid page__container">
                                        ...
                                        <h1 class="h2">Ajouter une nouveau catégorie</h1>

                                        <div class="card border-left-3 border-left-primary card-2by1 mt50">
                                            <div class="card-body">
                                                <div class="media flex-wrap align-items-center">
                                                    <div class="media-left col-md-8">
                                                        Ajouter une nouveau catégorie 
                                                    </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <form method="POST" action="<?php echo e(route('admin.store_cat')); ?>" enctype="multipart/form-data"   >
                                            ...
                                            <div class="bootstrap-filestyle input-group">
                                                ...
                                                <input type="text" class="form-control " placeholder="" disabled="">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input id="nom" value="<?php echo e(Request::old('nom')); ?>" name="nom" type="text" class="form-control" placeholder="Nom Categorie" > 
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select class="form-control select2-single  " name="type" id="type">
                                                                ...
                                                                <option <?php if(Request::old('type')=="Mix"){echo "selected";} ?> value="Mix">Mix</option>
...
<?php echo $__env->make('Admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c2mserver/public_html/caisse.gcmi.store/resources/views/Admin/cat/add_cat.blade.php ENDPATH**/ ?>