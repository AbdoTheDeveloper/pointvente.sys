                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card-counter primary">
                                          ...
                                          <span class="count-name">NiveauX</span>
                                        </div>
                                      </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                         <div class="card border-left-3 border-left-primary card-2by1 mt50">
                                              <div class="card-body">
                                                <h3 class="h2">Dernières classes ajoutées</h3>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                 ...
                                                                 <td>
                                                                    ...
                                                                    <span class="js-lists-values-employee-name"><?php echo e($classe->nbre_elev); ?></span>
...
<?php echo $__env->make('Admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-installation\xampp-5.6\htdocs\pointvente.sys\resources\views/Admin/index.blade.php ENDPATH**/ ?>