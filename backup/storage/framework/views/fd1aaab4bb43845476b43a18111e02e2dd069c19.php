...
<div class="mdk-drawer-layout__content page ">
    <div class="container page__container">
                    ...
                    <div class="col-lg-12">
                        <div class="table-responsive border-bottom" data-toggle="lists" data-lists-values='["js-lists-values-employee-name"]'>
                            ...
                            <table class="table table-centered table-bordered table-bordred table-striped" id="myTable">
                              ...
                              <?php $__currentLoopData = $avoirs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                    <tr>
                                        <td><input data-id="<?php echo e($vente->id_detail); ?>" class="select_detail" id="select_detail_<?php echo e($vente->id_detail); ?>" type="checkbox" /></td>
                                        <td><?php echo e($vente->id_avoir); ?></td>
                                        <td><?php echo e($vente->designation); ?></td>
                                        <td><?php echo e($vente->nom); ?></td>
                                        <td><?php echo e($vente->qte_rendu); ?></td>
                                        <td><?php echo e($vente->prix_produit); ?></td>
                                    </tr>
        ...
        <form action="<?php echo e(route("fusionner-pv")); ?>" method="POST">
            ...
            <input hidden name="liste_avoir" value="<?php echo e(json_encode($unique_avoir)); ?>" />
            <input hidden id="selected_details" name="selected_details" value="" />

            <div class="form-group" style="display: flex;">
                <?php if($unique_ventes || $unique_avoir): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-installation\xampp-5.6\htdocs\pointvente.sys\resources\views/Admin/pv/vente-liste.blade.php ENDPATH**/ ?>