                                            ...
                                            <div class="bootstrap-filestyle input-group">
                                                ...
                                                <input type="text" class="form-control " placeholder="" disabled="">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input id="qte" value="<?php echo e(Request::old('qte')); ?>" name="qte" type="text" class="form-control" placeholder="Quantité " > 
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                   ...
                                                   <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input id="remise_max" value="<?php echo e(Request::old('remise_max')); ?>" name="remise_max" type="text" class="form-control" placeholder="Remise Max" > 
                                                        </div>
                                                    </div>
...
<?php echo $__env->make('Admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-installations\xampp5.6\htdocs\pointvente.sys\resources\views/Admin/article/add.blade.php ENDPATH**/ ?>